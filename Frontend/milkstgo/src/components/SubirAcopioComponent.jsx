...
class SubirAcopioComponent extends Component{
  ...
  onFileUpload = async (e) => {
    ...
    try {
        ...
        window.location.href = "/subirAcopio";
    } catch (error) {
        console.log(error);
    }
      ...
      <main>
        <div className="relative mx-auto mt-7 w-1/2 bg-gray-500 dark:bg-gray-500 rounded-xl border-gray-200">
          <label className="block text-center pt-2 text-sm font-bold text-gray-800 dark:text-gray-800">
            Cargar el archivo de datos para Acopio
          </label>
          <form encType="multipart/form-data">
            ...
            <button
              ...
              className="block mx-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            >
