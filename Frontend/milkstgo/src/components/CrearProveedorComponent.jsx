      ...
      <form>
        <div className="relative mx-auto w-1/2 bg-gray-500 dark:bg-gray-500 rounded-xl border-gray-200">
          ...
          <div className ="relative ml-6">
            ...
            <button
              className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 mb-7 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
